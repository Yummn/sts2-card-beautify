...
下载 Release 中带平台标记的安装包，解压后将 `CardBeautify` 文件夹放入游戏 `mods/` 目录。Android v103 使用 `CardBeautify-v0.5.3-Mobile-v103.zip`，PC v107.1 使用 `CardBeautify-v0.5.3-PC-v107.1.zip`。

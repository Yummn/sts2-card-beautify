...
public partial class MainFile : Node
{
    ...
    public static void Initialize()
    {
        ...
        Logger.Info("[CardBeautify] loaded v0.5.4: Biased Cognition keeps its native portrait aspect instead of applying a second landscape crop; encyclopedia selector scope and per-card selections remain preserved.");
    }
}
